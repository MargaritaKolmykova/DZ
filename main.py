...
def start(message, res=False):
    ...
    btn1 = types.KeyboardButton("✌️ Главное меню")
...
def get_text_messages(message):
    ...
    if ms_text == "Главное меню" or ms_text == "✌️ Главное меню" or ms_text == "Вернуться в главное меню":  # ..........
        markup = types.ReplyKeyboardMarkup(resize_keyboard=True)
        ...
        bot.send_message(chat_id, "Автор: Рита Колмыкова")
        key1 = types.InlineKeyboardMarkup()
        btn1 = types.InlineKeyboardButton(text="Напишите автору 📱", url="https://t.me/margaritt1")
        key1.add(btn1)
